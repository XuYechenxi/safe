...
class AttentionBlock(nn.Module):
    ...
    def __init__(
        ...
        # 检查是否可以使用flash attention（需要CUDA和flash_attn模块）
        use_flash = False
            ...
            try:
                ...
                if torch.cuda.is_available():
                    try:
                        ...
                        # flash_attn未安装，使用legacy attention
                        pass
            except:
                pass
        
        self.attention_type = "flash" if use_flash else "legacy"
        if use_flash:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        try:
            ...
            raise ImportError("flash_attn is required for flash attention. Install it with: pip install flash-attn --no-build-isolation")
